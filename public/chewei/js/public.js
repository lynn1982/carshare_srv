...
function setTitleHeader() {
    ...
    //插件
    var addPlugin = '<a href="addPlugin.html" class="selectTitle" target="iframe1">/ 添加插件</a>';
    var pluginVersion = '<a href="pluginVersion.html" class="selectTitle" target="iframe1">/ 插件版本</a>';
    var addPluginVersion = '<a href="pluginVersion.html" class="selectTitle" target="iframe1">/ 插件版本</a>' + 
